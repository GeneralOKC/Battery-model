...
def p2d_fast_fn_short(Np, Mp, Ms, delta_t, fn_fast, jac_fn, I_times, Iapp, Tf, Temp, cathode, electrolyte):
    start0 = timeit.default_timer()
    peq, sepq = get_battery_sections(Np, Mp, Ms, delta_t, Temp, cathode, electrolyte) #10
