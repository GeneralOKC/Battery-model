...
#    l = 8*1e-5;
    ...
    kap = 1
    u_initial = 1000
    return electrode_constants(eps, brugg, l, trans, D, kap, u_initial)
...
def electrolyte_constants_NMC_811():
    l = 1.2e-5
    eps = 0.47
    brugg = 2.57
    trans = 0.2594
...
def electrolyte_constants_NMC_811_tuned():
    l = 1.2e-5
    eps = 0.47
    brugg = 1.5
    trans = 0.2594
...
electrolytes = {'example': electrolyte_constants_example, 'LFP': electrolyte_constants_LFP, 'NMC_622': electrolyte_constants_NMC_622, 'NMC_532': electrolyte_constants_NMC_532, 'NMC_release': electrolyte_constants_NMC_release, 'NMC_811': electrolyte_constants_NMC_811, 'EC:EMC_3:7': electrolyte_constants_NMC_811_tuned}   
