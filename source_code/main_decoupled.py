...
path = 'python\\p2d_fast_solver-main\\all_in_release\\NMC_811_tuned'
p_electrode_constants, sep_constants = p_electrodes[cathode], electrolytes[electrolyte]
# I_times = None
# Iapp = np.zeros(1000)
# Iapp[0:300] = -3
# Iapp[500:700] = -5
...
fn, jac_fn = p2d_init_fast(Np, Mp, Ms, delta_t, T, cathode, electrolyte)
uvec_list, cmat_list, Rec_list, eta_list, voltages, phie_list, phis_list, psi_list, x, x_cs, times, time_stats = p2d_fast_fn_short(Np, Mp, Ms, delta_t, fn, jac_fn, I_times, Iapp, Tf, T, cathode, electrolyte)
...
num_plots = 5
name_file = 'figs_NMC_811_tuned'
plotter(num_plots, path, False, name_file)
export_res_text(path)